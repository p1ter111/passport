...
const english: TranslationSection = {
  ...
  passportHistoryIntro: "Trace the evolution from machine-readable documents to modern biometric passports.",
  passportHistoryNote: "Archive coverage: 199 countries · early covers are visual reconstructions",
  ...
  historyMachineReadableDescription: "The passport begins adopting the international machine-readable format.",
  historyEpassportTitle: "First ePassport generation",
  historyEpassportDescription: "Biometric chips become part of the modern passport standard.",
  historyBiometricTitle: "Biometric redesign",
  historyBiometricDescription: "Security printing and contactless identity features continue to evolve.",
